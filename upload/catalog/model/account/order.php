...
class ModelAccountOrder extends Model {
	...
	public function getOrderByOrderId($order_id) {
		...
		$order_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order` WHERE order_id = '" . (int)$order_id . "' AND customer_id != '0' AND order_status_id > '0'");
	...
	public function getOrderCommon($order_id,$user_id) {
		$order_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order` WHERE order_id = '" . (int)$order_id . "' AND customer_id = '" . $user_id . "' AND customer_id != '0' AND order_status_id > '0'");
	...
	public function getOrders($start = 0, $limit = 20) {
		...
		$query = $this->db->query("SELECT o.tracking_id,o.order_id, o.firstname, o.lastname, os.name as status, o.date_added, o.total, o.currency_code, o.currency_value FROM `" . DB_PREFIX . "order` o LEFT JOIN " . DB_PREFIX . "order_status os ON (o.order_status_id = os.order_status_id) WHERE o.customer_id = '" . (int)$this->customer->getId() . "' AND o.order_status_id > '0' AND o.store_id = '" . (int)$this->config->get('config_store_id') . "' AND os.language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY o.order_id DESC LIMIT " . (int)$start . "," . (int)$limit);
	...
	public function getUserOrders($user_id) {
		...
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order` WHERE customer_id = '" . (int)$user_id . "'");

		return $query->rows;
	}

	public function getUserOrderSingle($user_id) {
		...
		if($query->row['purchase_sponsor'] == MLM_COMPANY)
		{
	...
	public function PurchasedSharePartner()
	{
		...
		if(isset($purcahsed_share_product))
		{
			return $purcahsed_share_product;
