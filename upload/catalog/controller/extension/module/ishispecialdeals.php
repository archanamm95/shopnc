...
class ControllerExtensionModuleIshiSpecialDeals extends Controller {
	public function index($setting) {
		...
		$data['left_product'] = (isset($setting['left_product']) && $setting['left_product'] == 1) ? 1 : 0;
		$data['title'] = (isset($setting['title'][$language_id])) ? $setting['title'][$language_id] : '';
		
		if($data['left_product'] == 1){
			$data['rowclass'] = 'col-lg-9 col-md-9 col-sm-9 col-xs-9';
		}else{
			$data['rowclass'] = 'col-xs-12';
		}
