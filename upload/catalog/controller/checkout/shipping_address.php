...
class ControllerCheckoutShippingAddress extends Controller {
	public function index() {
		...
		unset($this->session->data['delivery_details']);

		$this->load->model('setting/setting');

		$this->model_setting_setting->updateFlatShippingCost($this->model_setting_setting->prviousFlatShippingCost());

		// if(isset($this->session->data['delivery_charge'])){
		// 	$data['delivery_charge']=$this->session->data['delivery_charge'];
		// }
		// else 
		// {
		...
		$data['member_register']=$this->session->data['member_register_eligibility'];
		...
		$data['current_user']=$this->customer->getId();
	...
	public function save() {
		...
		// {
		// 	if($this->request->post['country_id'] == "129" || $this->request->post['country_id'] == "188")
		// 	{
		 
		// 		$this->session->data['delivery_charge']="free";
		// 		$url= "http://nc.demo/index.php?route=checkout/checkout&flat_rate=free";
		//         $curl=curl_init($url);
		...
		// 		$this->session->data['delivery_charge']="charge";
		// 		$url= "http://nc.demo/index.php?route=checkout/checkout&flat_rate=charge";
		//         $curl=curl_init($url);
		//         curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
		//         curl_setopt($curl, CURLOPT_POST, false);
		//         curl_setopt($curl, CURLOPT_SSL_VERIFYPEER, false);
