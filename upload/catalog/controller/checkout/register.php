...
class ControllerCheckoutRegister extends Controller {
	public function index() {
		if(isset($this->request->get['guest_checkout']))
		{

			if ($this->request->get['guest_checkout'] == "1") {
			...
			$data['guest_checkout']=$this->session->data['guest_checkout'];
		...
		// if ($this->request->get['eligibility'] == "eligible" && !isset($this->session->data['purchase_session'])) {
	...
	public function save() {
	    ...
	    //END CHECK IF EMAIL EXIST IN MLM 
