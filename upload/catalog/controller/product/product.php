...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if(isset($this->session->data['dealer']))
		{
			if($this->session->data['dealer'] == false)
			{

			//Check if User is not Dealer
			...
			if($share_product == true)
			{
				// Restrict sharepartner link for non dealer
				$product_id=0;
			}
		...
		if(isset($product_attributes[0]['attribute'][0]['text']))
		{
			$data['short_description']=$product_attributes[0]['attribute'][0]['text'];
		}
		else
		{
			$data['short_description']=false;
		}
		...
		if ($product_info) {
			...
			$data['productimage_type'] = $themeinfo['productimage_type'];
