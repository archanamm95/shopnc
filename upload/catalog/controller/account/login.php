...
class ControllerAccountLogin extends Controller {
	...
	public function index() {
		...
		if (!empty($this->request->get['token'])) {
			...
			unset($this->session->data['purchase_link_member_register']);
        ...
        // Check if they are using their purcahse/referal link

        if(isset($this->session->data['purchase_session']))
        {
        	if($this->session->data['purchase_session'] == $this->customer->getUsername())
        	{
        ...
        if(isset($this->session->data['referral_session']))
        {
        	if($this->session->data['referral_session'] == $this->customer->getUsername())
        	{
		...
		// Check if they are using their purcahse/referal link Ends
