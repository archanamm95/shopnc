...
class ControllerAccountOrder extends Controller {
	...
	public function order_info() {
		...
		if($order_id != 0)
		{
			$order_details=$this->model_account_order->getOrderByOrderId($order_id);
		...
		$order_info = $this->model_account_order->getOrderCommon($order_id,$customer_id);
		...
		if (is_file(DIR_IMAGE . $this->config->get('config_logo'))) {
			...
			$this->response->setOutput($this->load->view('account/order_info_common', $data));
		} else {
