...
class ModelSettingSetting extends Model {
	...
	public function editSetting($code, $data, $store_id = 0) {
		...
		$this->db->query("UPDATE `" . DB_PREFIX . "setting` SET value = '" .$data['shipping_flat_cost'] . "' WHERE code = 'shipping_flat_previous'");
