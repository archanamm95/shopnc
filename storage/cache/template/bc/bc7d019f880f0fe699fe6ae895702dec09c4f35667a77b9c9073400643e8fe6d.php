...
/* glamour/template/checkout/confirm.twig */
class __TwigTemplate_f7fb1d72b10cfdb1819cda7abc06263d962e50fb8af10d6483ccd3b153f87c67 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
 ...
 \$(document ).ready(function() {
    ...
    \$('#progress').val('95');
     ...
     \$('#login_button').attr('aria-expanded', 'false');
     \$('#account_button').attr('aria-expanded', 'false');
     \$('#mlm_button').attr('aria-expanded', 'false');
     \$('#billing_details').attr('aria-expanded', 'false');
     \$('#delivery_method').attr('aria-expanded', 'false');
     \$('#delivery_details').attr('aria-expanded', 'false');
     \$('#payment_button').attr('aria-expanded', 'false');
     \$('#confirm_button').attr('aria-expanded', 'true');
    ...
    {
        return "glamour/template/checkout/confirm.twig";
    }
    ...
    {
        return new Source("", "glamour/template/checkout/confirm.twig", "");
    }
}
